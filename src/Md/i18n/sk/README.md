...
<script type="module">
  ...
  el.textContent = "#Nový názov\nNový obsah";
</script>
```

## Parametre rozhrania

Odovzdajte text Markdown priamo v rámci značky (ako predvolený priestor) alebo aktualizujte dynamicky prostredníctvom `textContent`.
