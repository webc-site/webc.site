...
- اي ميل پتي ۽ موبائل فون نمبر جي وچ ۾ ٽيب سوئچنگ کي سپورٽ ڪري ٿو
- مائع گلاس جي بناوت سان سچل ليبل
- گھڻن ملڪ واري علائقي جي ڪوڊ جي چونڊ ۽ ايس ايم ايس جي تصديق واري ڪوڊ جي ڳڻپ کي سپورٽ ڪري ٿو
...
auth.onMail = async (mail) => {
  // واپسي واري اسٽيٽس ڪوڊ: 1 تصديقي ڪوڊ جي رجسٽريشن لاءِ، 2 پاسورڊ لاگ ان لاءِ، يا ٽئين پارٽي جي لاگ ان صف کي واپس ڪريو ["google"، "apple"]
  return 2;
};
...
- `cc`: بين الاقوامي ڊائلنگ ڪوڊ (ڊفالٽ 86)
- `onMail(mail)`: اي ميل چيڪ ڪال بيڪ
- `onSignup(mail, name, password)`: ڪال بڪ رجسٽر ڪريو
- `onLogin(mail, password)`: پاسورڊ لاگ ان ڪال بيڪ
- `onSmsSend(phone, cc)`: ايس ايم ايس تصديقي ڪوڊ ڪال بيڪ موڪليو
- `onSmsVerify(phone, cc, code)`: تصديق ايس ايم ايس تصديق ڪوڊ ڪال بيڪ
