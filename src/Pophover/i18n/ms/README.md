...
### sambungan gaya
Reka letak asas, saiz (18x18px) dan perubahan warna tuding telah disatukan dalam `.Ico > c-pophover > a`. Pembangun hanya perlu menentukan fail ikon yang sepadan secara berasingan:
```stylus
c-edit > c-pophover > a
