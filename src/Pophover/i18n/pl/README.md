...
### przedłużenie stylu
Podstawowy układ, rozmiar (18x18px) i zmiany koloru po najechaniu myszką zostały ujednolicone w `.Ico > c-pophover > a`. Programiści muszą jedynie osobno określić odpowiedni plik ikony:
```stylus
c-edit > c-pophover > a
