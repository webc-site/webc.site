...
### extension de style
La mise en page de base, la taille (18 x 18 px) et les modifications de couleur de survol ont été unifiées dans `.Ico > c-pophover > a`. Les développeurs doivent uniquement spécifier séparément le fichier d'icône correspondant :
```stylus
c-edit > c-pophover > a
