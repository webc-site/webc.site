...
### Stilerweiterung
Das grundlegende Layout, die Größe (18 x 18 Pixel) und die Änderungen der Hover-Farbe wurden in `.Ico > c-pophover > a` vereinheitlicht. Entwickler müssen lediglich die entsprechende Symboldatei separat angeben:
```stylus
c-edit > c-pophover > a
