...
### tyylin laajennus
Perusasettelu, koko (18x18px) ja hover-värimuutokset on yhtenäistetty kohdassa `.Ico > c-pophover > a`. Kehittäjien tarvitsee vain määrittää vastaava kuvaketiedosto erikseen:
```stylus
c-edit > c-pophover > a
