...
### stila paplašinājums
Pamata izkārtojums, izmērs (18 x 18 pikseļi) un kursora virzīšanas krāsas izmaiņas ir apvienotas sadaļā `.Ico > c-pophover > a`. Izstrādātājiem tikai atsevišķi jānorāda atbilstošais ikonas fails:
```stylus
c-edit > c-pophover > a
