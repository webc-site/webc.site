...
### stil uzantısı
Temel düzen, boyut (18x18 piksel) ve fareyle üzerine gelme rengi değişiklikleri `.Ico > c-pophover > a`'de birleştirildi. Geliştiricilerin yalnızca ilgili simge dosyasını ayrı ayrı belirtmeleri gerekir:
```stylus
c-edit > c-pophover > a
