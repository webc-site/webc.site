...
### stíluskiterjesztés
Az alapvető elrendezés, a méret (18x18 képpont) és a lebegtetés színváltoztatása egységes lett a `.Ico > c-pophover > a`-ben. A fejlesztőknek csak a megfelelő ikonfájlt kell külön megadniuk:
```stylus
c-edit > c-pophover > a
