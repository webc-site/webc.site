...
### rozšírenie štýlu
Zmeny základného rozloženia, veľkosti (18 x 18 pixelov) a farby pri umiestnení kurzora myši boli zjednotené v `.Ico > c-pophover > a`. Vývojári musia iba samostatne špecifikovať príslušný súbor ikony:
```stylus
c-edit > c-pophover > a
