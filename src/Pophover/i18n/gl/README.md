...
### extensión de estilo
O deseño básico, o tamaño (18 x 18 px) e os cambios de cor ao pasar o rato unificáronse en `.Ico > c-pophover > a`. Os desenvolvedores só precisan especificar o ficheiro de icona correspondente por separado:
```stylus
c-edit > c-pophover > a
