...
### estensjoni tal-istil
It-tqassim bażiku, id-daqs (18x18px), u l-bidliet fil-kulur tal-hover ġew unifikati f'`.Ico > c-pophover > a`. L-iżviluppaturi jeħtieġ biss li jispeċifikaw il-fajl tal-ikona korrispondenti separatament:
```stylus
c-edit > c-pophover > a
