...
### ekstensi gaya
Tata letak dhasar, ukuran (18x18px), lan owah-owahan werna hover wis digabungake ing `.Ico > c-pophover > a`. Pangembang mung kudu nemtokake file lambang sing cocog kanthi kapisah:
```stylus
c-edit > c-pophover > a
