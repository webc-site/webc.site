...
### proširenje stila
Osnovni izgled, veličina (18x18px) i promjene boje pri lebdenju su objedinjene u `.Ico > c-pophover > a`. Programeri samo trebaju posebno specificirati odgovarajuću datoteku ikona:
```stylus
c-edit > c-pophover > a
