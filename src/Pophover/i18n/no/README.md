...
### stilutvidelse
Grunnleggende layout, størrelse (18x18px) og fargeendringer for sveve er blitt forent i `.Ico > c-pophover > a`. Utviklere trenger bare å spesifisere den tilsvarende ikonfilen separat:
```stylus
c-edit > c-pophover > a
