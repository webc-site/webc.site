...
### stiludvidelse
Det grundlæggende layout, størrelse (18x18px) og svævefarveændringer er blevet forenet i `.Ico > c-pophover > a`. Udviklere behøver kun at angive den tilsvarende ikonfil separat:
```stylus
c-edit > c-pophover > a
