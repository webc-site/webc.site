...
### extension ng istilo
Ang pangunahing layout, laki (18x18px), at mga pagbabago sa kulay ng hover ay pinag-isa sa `.Ico > c-pophover > a`. Kailangan lang ng mga developer na tukuyin ang kaukulang icon na file nang hiwalay:
```stylus
c-edit > c-pophover > a
