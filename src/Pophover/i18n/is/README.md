...
### stíllenging
Grunnskipulag, stærð (18x18px) og litabreytingar á sveimi hafa verið sameinaðar í `.Ico > c-pophover > a`. Hönnuðir þurfa aðeins að tilgreina samsvarandi táknskrá sérstaklega:
```stylus
c-edit > c-pophover > a
