...
`c-t` to niestandardowy, umiędzynarodowiony tag, który musi być wcięty w oddzielną linię jako węzeł podrzędny (zapisywanie w tej samej linii jest surowo zabronione):
Poprawny przykład:
```pug
