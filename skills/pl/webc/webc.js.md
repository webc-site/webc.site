  ...
  Użyj ścieżek względnych, aby zaimportować inne komponenty, np.: `import "./component name.js"` (W pliku JS każdego komponentu na początku należy zaimportować odpowiedni `_.styl`, np. `import "./component name/_.styl";`).
