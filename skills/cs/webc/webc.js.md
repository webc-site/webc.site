  ...
  K importu dalších komponent použijte relativní cesty, například: `import "./component name.js"` (V souboru JS každé komponenty nejprve importujte závislosti a poté importujte odpovídající `_.styl`, například `import "./component name/_.styl";`).
