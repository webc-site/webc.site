...
`c-t` is een aangepaste geïnternationaliseerde tag, die als onderliggend knooppunt op een aparte regel moet worden ingesprongen (schrijven op dezelfde regel is ten strengste verboden):
Correct voorbeeld:
```pug
