  ...
  Gebruik relatieve paden om andere componenten te importeren, zoals: `import "./component name.js"` (In het JS-bestand van elke component moet de corresponderende `_.styl` aan het begin worden geïmporteerd, zoals `import "./component name/_.styl";`).
