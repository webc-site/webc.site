  ...
  Uporabite relativne poti za uvoz drugih komponent, kot je: `import "./component name.js"` (V datoteki JS vsake komponente mora biti ustrezen `_.styl` uvožen na začetku, kot je `import "./component name/_.styl";`).
