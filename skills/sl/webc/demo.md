...
Glejte `src/BoxX/demo` in razvijte predstavitev komponente v `src/ime komponente/demo/`
...
Ne pišite `@import '../_.styl'`, da uvozite komponento, ki jo želite prikazati, samodejno bo vstavljena

Uvozite `@import '../../Btn/_.styl'` v `demo/_.styl` in uporabite `.Btn`
...
Če `../_.js` (`../_.js` mora prikazati samo komponento, je treba še vedno uvoziti odvisne komponente, ki jih zahtevajo druge predstavitve), je zahtevan samo `import` in ni uvožena nobena posebna vsebina, ki jo je mogoče izpustiti (ogrodje jo bo samodejno vbrizgalo)
