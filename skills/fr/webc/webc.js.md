  ...
  Utilisez des chemins relatifs pour importer d'autres composants, tels que : `import "./component name.js"` (Dans le fichier JS de chaque composant, le `_.styl` correspondant doit être importé au début, comme `import "./component name/_.styl";`).
