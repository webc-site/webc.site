...
`c-t` é uma tag internacionalizada personalizada, que deve ser recuada em uma linha separada como um nó filho (escrito na mesma linha é estritamente proibido):
Exemplo correto:
```pug
