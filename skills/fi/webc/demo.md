...
`c-t` on mukautettu kansainvälistetty tunniste, joka on sisennettävä erilliselle riville alisolmuna (samalle riville kirjoittaminen on ehdottomasti kielletty):
Oikea esimerkki:
```pug
