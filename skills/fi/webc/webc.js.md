  ...
  Käytä suhteellisia polkuja muiden komponenttien tuomiseen, kuten: `tuo "./komponentin nimi.js"` (Jokaisen komponentin JS-tiedoston alussa on tuotava vastaava `_.styl`, kuten `tuo "./komponentin nimi/_.styl";`).
