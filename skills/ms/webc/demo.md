...
`c-t` ialah teg antarabangsa tersuai, yang mesti diindenkan ke dalam baris berasingan sebagai nod anak (ditulis dalam baris yang sama adalah dilarang sama sekali):
Contoh yang betul:
```pug
