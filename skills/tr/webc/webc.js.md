  ...
  `js` bileşeni için, bileşeni `src/component name/_.js` içinde uygulamak için `Light DOM` kullanın.

  Diğer bileşenleri içe aktarmak için göreli yollar kullanın, örneğin: `import "../component name/_.js"` (`js` `styl`'yi içe aktarmaz, çerçeve onu otomatik olarak enjekte eder).
  ...
  Geri arama yüklenirken animasyonu `const xx = newEl('b');xx.className="Ing"` ve `@import "../Ing/_.styl"` ile `_.styl` içinde göster