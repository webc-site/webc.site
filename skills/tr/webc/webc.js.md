  ...
  Diğer bileşenleri içe aktarmak için göreli yollar kullanın, örneğin: `import "./component name.js"` (Her bileşenin JS dosyasında, `import "./component name/_.styl";` gibi, karşılık gelen `_.styl` başlangıçta içe aktarılmalıdır).
