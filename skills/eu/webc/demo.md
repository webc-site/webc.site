...
`c-t` nazioartekotutako etiketa pertsonalizatua da, nodo ume gisa bereizitako lerro batean koska egin behar duena (lerro berean idaztea guztiz debekatuta dago):
Adibide zuzena:
```pug
