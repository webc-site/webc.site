  ...
  Kwa kipengele cha `js`, tekeleza kijenzi ukitumia `Light DOM` katika `src/webc/componentname.js`.

  Tumia njia linganishi kuleta vipengele vingine, kama vile: `kuagiza "./component name.js"` (Katika faili ya JS ya kila kijenzi, leta vitegemezi kwanza, na kisha ulete `_.styl`, kwa mfano `import "./component name/_.styl";`).
  ...
  Wakati urejeshaji wa simu unapakia, tumia `const xx = newEl('b');xx.className="Ing"` kuonyesha uhuishaji, na tambulisha vitegemezi kupitia `import "./Ing.js"` katika kijenzi cha faili ya JS.