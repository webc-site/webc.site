...
Consultați `src/BoxX/demo` și dezvoltați o demonstrație a componentei în `src/component name/demo/`
...
Nu scrie `@import '../_.styl'` pentru a importa componenta care urmează să fie demonstrată, aceasta va fi injectată automat

Importați `@import '../../Btn/_.styl'` în `demo/_.styl` și utilizați `.Btn`
...
Dacă `../_.js` (`../_.js` urmează să afișeze componenta în sine, componentele dependente cerute de alte demonstrații trebuie încă importate) este necesar doar `import` și nu este importat niciun conținut specific, care poate fi omis (cadru-ul îl va injecta automat)
