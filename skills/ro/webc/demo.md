...
`c-t` este o etichetă internaționalizată personalizată, care trebuie indentată într-o linie separată ca nod copil (scris în aceeași linie este strict interzis):
Exemplu corect:
```pug
