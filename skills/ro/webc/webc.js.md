  ...
  Utilizați căi relative pentru a importa alte componente, cum ar fi: `import "./component name.js"` (În fișierul JS al fiecărei componente, `_.styl` corespunzător trebuie importat la început, cum ar fi `import "./component name/_.styl";`).
