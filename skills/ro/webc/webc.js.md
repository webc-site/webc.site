  ...
  Pentru componenta `js`, utilizați `Light DOM` pentru a implementa componenta în `src/component name/_.js`.

  Utilizați căi relative pentru a importa alte componente, cum ar fi: `import „../component name/_.js”` (`js` nu importă `styl`, cadrul îl va injecta automat).
  ...
  În timp ce apelul invers se încarcă, afișați animația cu `const xx = newEl('b');xx.className="Ing"` și `@import "../Ing/_.styl"` în `_.styl`