  ...
  Használjon relatív elérési utat más összetevők importálásához, például: `import "./component name.js"` (Az egyes összetevők JS-fájljában a megfelelő `_.styl`-t kell az elején importálni, például `import "./component name/_.styl";`).
