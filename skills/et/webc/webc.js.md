  ...
  Kasutage teiste komponentide importimiseks suhtelisi teid, näiteks: `importige "./component name.js"` (Importige esmalt iga komponendi JS-failis sõltuvused ja seejärel importige vastav `_.styl`, näiteks `import "./component name/_.styl";`).
