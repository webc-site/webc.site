  ...
  Boshqa komponentlarni import qilish uchun nisbiy yo‘llardan foydalaning, masalan: `import "./component name.js"` (Har bir komponentning JS faylida avval bog‘liqliklarni import qiling, so‘ngra tegishli `_.styl`ni import qiling, masalan `import "./component name/_.styl";`).
