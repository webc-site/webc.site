  ...
  Gebruik relatiewe paaie om ander komponente in te voer, soos: `invoer "./komponentnaam.js"` (In die JS-lêer van elke komponent moet die ooreenstemmende `_.styl` aan die begin ingevoer word, soos `invoer "./komponentnaam/_.styl";`).
