...
`c-t` es una etiqueta internacionalizada personalizada, que debe tener sangría en una línea separada como nodo secundario (está estrictamente prohibido escribir en la misma línea):
Ejemplo correcto:
```pug
button.Btn(type="button")
  nombre de la clave c-t
```
