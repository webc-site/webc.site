  ...
  Utilizza percorsi relativi per importare altri componenti, come ad esempio: `import "./nome componente.js"` (Nel file JS di ciascun componente, il corrispondente `_.styl` deve essere importato all'inizio, come ad esempio `import "./nome componente/_.styl";`).
