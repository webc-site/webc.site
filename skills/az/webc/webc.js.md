  ...
  Digər komponentləri idxal etmək üçün nisbi yollardan istifadə edin, məsələn: `import "./component name.js"` (Hər komponentin JS faylında əvvəlcə asılılıqları idxal edin, sonra müvafiq `_.styl`i import edin, məsələn `import "./component name/_.styl";`).
