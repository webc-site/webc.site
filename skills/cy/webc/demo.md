...
Mae `c-t` yn dag rhyngwladol wedi'i deilwra, y mae'n rhaid ei fewnoli i linell ar wahân fel nod plentyn (mae wedi'i ysgrifennu yn yr un llinell wedi'i wahardd yn llym):
Enghraifft gywir:
```pug
