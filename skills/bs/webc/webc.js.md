  ...
  Koristite relativne putanje za uvoz drugih komponenti, kao što su: `import "./component name.js"` (U JS datoteci svake komponente prvo uvezite zavisnosti, a zatim uvezite odgovarajući `_.styl`, na primjer `import "./component name/_.styl";`).
