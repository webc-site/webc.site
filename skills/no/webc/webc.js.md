  ...
  Bruk relative baner for å importere andre komponenter, for eksempel: `import "./komponentnavn.js"` (I JS-filen til hver komponent importerer du avhengighetene først, og importerer deretter tilsvarende `_.styl`, for eksempel `importer "./komponentnavn/_.styl";`).
