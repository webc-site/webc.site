...
`c-t` é unha etiqueta internacionalizada personalizada, que debe ser sangría nunha liña separada como un nodo fillo (escrito na mesma liña está estrictamente prohibido):
Exemplo correcto:
```pug
