  ...
  Use camiños relativos para importar outros compoñentes, como: `import "./component name.js"` (No ficheiro JS de cada compoñente, importe primeiro as dependencias e, a continuación, importe o `_.styl` correspondente, por exemplo `import "./component name/_.styl";`).
