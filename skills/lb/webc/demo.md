...
`c-t` ass e personaliséierten internationaliséierten Tag, deen an eng getrennte Linn als Kannerknuet agedréckt muss ginn (an der selwechter Linn geschriwwen ass streng verbueden):
Richteg Beispill:
```pug
