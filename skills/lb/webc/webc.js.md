  ...
  Benotzt relativ Weeër fir aner Komponenten z'importéieren, wéi: `Import "./component name.js"` (An der JS-Datei vun all Komponent importéiert d'Ofhängegkeeten als éischt, an importéiert dann déi entspriechend `_.styl`, zum Beispill `import "./Component name/_.styl";`).
