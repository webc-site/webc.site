...
`c-t` je vlastná internacionalizovaná značka, ktorá musí byť odsadená do samostatného riadku ako podriadený uzol (napísanie do rovnakého riadku je prísne zakázané):
Správny príklad:
```pug
