  ...
  Na import iných komponentov použite relatívne cesty, ako napríklad: `import "./component name.js"` (V súbore JS každého komponentu najprv importujte závislosti a potom importujte zodpovedajúci `_.styl`, napríklad `import "./component name/_.styl";`).
