  ...
  Gunakan jalur relatif untuk mengimpor komponen lain, seperti: `import "./component name.js"` (Dalam file JS setiap komponen, impor dependensi terlebih dahulu, lalu impor `_.styl` yang sesuai, misalnya `import "./component name/_.styl";`).
