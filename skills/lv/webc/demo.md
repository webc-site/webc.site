...
Skatiet `src/BoxX/demo` un izstrādājiet komponenta demonstrāciju šeit: `src/component name/demo/`
...
Nerakstiet `@import '../_.styl'`, lai importētu demonstrējamo komponentu, tas tiks automātiski ievadīts

Lūdzu, importējiet `@import '../../Btn/_.styl'` mapē `demo/_.styl` un izmantojiet `.Btn`
...
Ja `../_.js` (`../_.js` ir jāparāda pats komponents, joprojām ir jāimportē atkarīgie komponenti, kas nepieciešami citām demonstrācijām), ir nepieciešams tikai `import` un netiek importēts konkrēts saturs, ko var izlaist (ietvars to automātiski ievadīs)
