...
`c-t` ir pielāgots internacionalizēts tags, kas jāiekļauj atsevišķā rindā kā pakārtots mezgls (rakstīšana tajā pašā rindā ir stingri aizliegta):
Pareizs piemērs:
```pug
button.Btn(type="button")
  c-t atslēgas nosaukums
```
