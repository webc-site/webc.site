  ...
  Izmantojiet relatīvos ceļus, lai importētu citus komponentus, piemēram: `importēt "./component name.js"` (Katra komponenta JS failā vispirms importējiet atkarības un pēc tam importējiet atbilstošo `_.styl`, piemēram, `importējiet "./component name/_.styl";`).
