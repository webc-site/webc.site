...
`c-t` yra tinkinta internacionalizuota žyma, kuri turi būti įtraukta į atskirą eilutę kaip antrinis mazgas (rašyti toje pačioje eilutėje griežtai draudžiama):
Teisingas pavyzdys:
```pug
button.Btn(type="button")
  c-t rakto pavadinimas
```
