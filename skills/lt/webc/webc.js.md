  ...
  Naudokite santykinius kelius, kad importuotumėte kitus komponentus, pvz.: `importuokite "./component name.js"` (Kiekvieno komponento JS faile pirmiausia importuokite priklausomybes, o tada importuokite atitinkamą `_.styl`, pvz., `importuokite "./component name/_.styl";`).
