  ...
  Koristite relativne putove za uvoz drugih komponenti, kao što je: `import "./component name.js"` (U JS datoteci svake komponente, odgovarajući `_.styl` mora biti uvezen na početku, kao što je `import "./component name/_.styl";`).
