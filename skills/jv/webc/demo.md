...
`c-t` minangka tag internasionalisasi khusus, sing kudu dilebokake ing baris sing kapisah minangka simpul anak (ditulis ing baris sing padha dilarang banget):
Tuladha sing bener:
```pug
