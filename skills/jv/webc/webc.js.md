  ...
  Kanggo komponen `js`, gunakake `Light DOM` kanggo ngleksanakake komponen ing `src/component name/_.js`.

  Gunakake jalur relatif kanggo ngimpor komponen liyane, kayata: `import "../component name/_.js"` (`js` ora ngimpor `styl`, framework bakal nyuntikake kanthi otomatis).
  ...
  Nalika callback lagi dimuat, tuduhake animasi nganggo `const xx = newEl('b');xx.className="Ing"` lan `@import "../Ing/_.styl"` ing `_.styl`