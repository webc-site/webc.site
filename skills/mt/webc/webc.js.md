  ...
  Uża mogħdijiet relattivi biex timporta komponenti oħra, bħal: `import "./component name.js"` (Fil-fajl JS ta 'kull komponent, l-ewwel jimporta d-dipendenzi, u mbagħad jimporta l-`_.styl` korrispondenti, pereżempju `import "./component name/_.styl";`).
