...
`c-t` hija tikketta personalizzata internazzjonalizzata, li għandha tkun indentata f'linja separata bħala node tifel (miktub fl-istess linja hija strettament ipprojbita):
Eżempju korrett:
```pug
button.Btn(type="button")
  isem taċ-ċavetta c-t
```
