  ...
  Använd relativa sökvägar för att importera andra komponenter, till exempel: `importera "./komponentnamn.js"` (I JS-filen för varje komponent måste motsvarande `_.styl` importeras i början, t.ex. `importera "./komponentnamn/_.styl";`).
