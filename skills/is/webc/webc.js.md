  ...
  Notaðu hlutfallslegar slóðir til að flytja inn aðra íhluti, eins og: `innflutningur "./component name.js"` (Í JS skrá hvers íhluta þarf að flytja inn samsvarandi `_.styl` í upphafi, eins og `innflutningur "./component name/_.styl";`).
