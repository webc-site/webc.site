  ...
  Utilitzeu camins relatius per importar altres components, com ara: `import "./component name.js"` (al fitxer JS de cada component, s'ha d'importar el `_.styl` corresponent al principi, com ara `import "./component name/_.styl";`).
