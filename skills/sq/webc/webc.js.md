  ...
  Përdorni shtigje relative për të importuar komponentë të tjerë, si p.sh.: `import "./component name.js"` (Në skedarin JS të secilit komponent, fillimisht importoni varësitë dhe më pas importoni `_.styl` përkatëse, për shembull `import "./component name/_.styl";
