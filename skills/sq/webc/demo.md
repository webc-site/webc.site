...
`c-t` është një etiketë e personalizuar e ndërkombëtarizuar, e cila duhet të futet në një rresht të veçantë si një nyje fëmijë (e shkruar në të njëjtën linjë është rreptësisht e ndaluar):
Shembulli i saktë:
```pug
