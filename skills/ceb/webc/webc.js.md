  ...
  Gamita ang mga relatibong agianan sa pag-import sa ubang mga component, sama sa: `import "./component name.js"` (Sa JS file sa matag component, ang katugbang nga `_.styl` kinahanglang i-import sa sinugdanan, sama sa `import "./component name/_.styl";`).
