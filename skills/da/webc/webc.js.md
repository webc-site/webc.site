  ...
  Brug relative stier til at importere andre komponenter, såsom: `import "./komponentnavn.js"` (I JS-filen for hver komponent skal den tilsvarende `_.styl` importeres i begyndelsen, såsom `import "./komponentnavn/_.styl";`).
