...
Ang `c-t` ay isang custom na internationalized na tag, na dapat na naka-indent sa isang hiwalay na linya bilang isang child node (mahigpit na ipinagbabawal ang nakasulat sa parehong linya):
Tamang halimbawa:
```pug
