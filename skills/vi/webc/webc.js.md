  ...
  Sử dụng đường dẫn tương đối để nhập các thành phần khác, chẳng hạn như: `import "./comComponent name.js"` (Trong tệp JS của mỗi thành phần, `_.styl` tương ứng phải được nhập ngay từ đầu, chẳng hạn như `import "./comComponent name/_.styl";`).
